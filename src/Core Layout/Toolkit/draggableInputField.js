...
const InputSource = {
 ...
 class DraggableInputField extends Component {
      ...
      render() {
          ...
          return connectDragSource(<div style={{height: `${50}px` , width: `${200}px`, marginTop: `${100}px`, marginLeft: `${-30}px` }}><input type={this.props.type} placeholder='write something'/></div>)  ;
        }
    }

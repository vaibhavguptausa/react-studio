...
const normalCheckboxSource = {
 ...
 class NormalCheckbox extends Component {
     ...
     {
         super(props);
         this.state = { modalState: false, height: 50, width: 70, color: 'yellow', type: 'checkbox'};
     }
     handleClick = (e) => {
      if (e.type === 'click') {
  ...
  handleChangeAttributes = (parameters) => {
    ...
    export default DragSource(ItemTypes.NORMALCHECKBOX, normalCheckboxSource, (connect, monitor,Component) => ({
